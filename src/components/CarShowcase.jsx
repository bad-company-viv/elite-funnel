...
const CARS = [
    {
        ...
        price: '₹8,000',
        unit: '/ day',
        features: ['Chauffeur Driven', 'Massaging Seats', 'Panoramic Sunroof', 'Burmester Sound'],
        badge: 'Most Booked',
        badgeColor: '#c9a84c',
    ...
    },
    {
        ...
        price: '₹7,500',
        unit: '/ day',
        features: ['Executive Package', 'Sky Lounge Roof', 'Bowers & Wilkins Audio', 'Gesture Control'],
        badge: 'Premium',
        badgeColor: '#b0b0b0',
    ...
    },
    {
        ...
        price: '₹7,000',
        unit: '/ day',
        features: ['Quattro AWD', 'Rear Seat Entertainment', 'Matrix LED', 'Bang & Olufsen'],
        badge: 'Top Rated',
        badgeColor: '#c9a84c',
    ...
    },
    {
        ...
        price: '₹9,000',
        unit: '/ day',
        features: ['Terrain Response', 'Meridian Sound', '23" Wheels', 'Air Suspension'],
        badge: 'Exclusive',
        badgeColor: '#e8c96c',
        occasions: ['Wedding', 'Adventure', 'Corporate'],
        image: '/images/Range.jpeg',
    },
]
        ...
        <section id="fleet" className="section fleet-section">
            <div className="container">
                ...
                >
                    ...
                    <p className="section-subtitle">Hand-selected, meticulously maintained luxury vehicles for every occasion</p>
                </motion.div>
                    ...
                    <AnimatePresence mode="popLayout">
                        {visible.map((car, i) => (
                            ...
                            >
                                ...
                                >
                                    {/* Badge */}
                                    <div className="car-badge" style={{ background: car.badgeColor }}>
                                        {car.badge}
                                    </div>
                                    ...
                                    <div className="car-body">
                                        ...
                                        <div className="car-occasions">
                                            {car.occasions.map(o => (
                                                <span key={o} className="occasion-tag">{o}</span>
                                            ))}
                                        </div>
                                        ...
                                        <div className="car-ctas">
                                            ...
                                            <a href="tel:+919529375167" className="btn btn-outline car-btn">
                                                Call
                                            </a>
                                        </div>
                                    </div>
