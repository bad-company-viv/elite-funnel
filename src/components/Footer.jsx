            ...
            <div className="container footer-grid">
                ...
                <div className="footer-brand">
                    ...
                    <div className="footer-contact">
                        <a href="tel:+919920053379" className="footer-contact-item">
                    ...
                    <div className="footer-social">
                        ...
                        <a href="https://wa.me/919920053379" target="_blank" rel="noreferrer" className="social-btn" aria-label="WhatsApp">
